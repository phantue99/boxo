...
require (
	github.com/AIOZNetwork/aioz-image-optimizer v0.0.4
...
replace github.com/AIOZNetwork/aioz-image-optimizer => 10.0.0.50/hung.gia.lam/aioz-image-optimizer v0.0.4
